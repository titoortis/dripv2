...
function AppHeader() {
  return (
    <header className="pt-safe">
      <div className="px-safe flex items-center justify-between py-3">
        <Link href="/" className="flex items-center gap-2">
          <Logo />
          <span className="heading-display text-[15px] tracking-tight text-ink-100">drip</span>
        </Link>
        <Link
          href="/history"
          className="rounded-full bg-ink-800 px-3 py-1.5 text-xs font-medium text-ink-200 ring-soft hover:bg-ink-700"
        >
          My videos
        </Link>
      </div>
